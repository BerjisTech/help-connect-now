      ...
      <footer className="bg-white border-t pt-16 pb-8">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div>
              <h3 className="text-lg font-bold mb-4">Help Connect Now</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Business Consulting</a></li>
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Career Coaching</a></li>
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Technology Help</a></li>
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Legal Assistance</a></li>
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Financial Advice</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-600 hover:text-primary transition-colors">Knowledge Base</a></li>
